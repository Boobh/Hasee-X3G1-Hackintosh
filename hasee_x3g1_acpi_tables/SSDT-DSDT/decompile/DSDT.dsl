 ...
 *
 * Disassembly of DSDT.aml, Sun Mar 22 11:43:17 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00016D22 (93474)
 *     Revision         0x02
 *     Checksum         0xA1
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
     ...
     * disassembly, but only 18 were resolved (11 unresolved). Additional
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xA4D25000, 0x0366)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xA4353F18, 0x10)
    ...
    Scope (_SB.PCI0.XHC.RHUB)
    {
        ...
        Name (PLDJ, Package (0x01)
        {
            ...
            {
                /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00,
                /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                         
            }
        })
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        ...
        Device (FCAM)
        {
            ...
            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
            {
                Name (PLDP, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        /* 0008 */  0x60, 0x01, 0x80, 0x02, 0x00, 0x00, 0x00, 0x00,
                        /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                         
                    }
                })
                Return (PLDP)
    ...
    OperationRegion (ABNV, SystemMemory, 0xA49D2000, 0x000D)
    ...
    Device (_SB.TPM)
    {
        ...
        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
        {
            ...
            Else
            {
                ...
                {
                    CreateDWordField (CRSI, \_SB.TPM._Y38._BAS, MTFF)  // _BAS: Base Address
                    Store (TPMM, MTFF)
                    Return (CRSI)
                }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (H_EC)
        {
            ...
            Method (CFTD, 0, Serialized)
            {
                ...
                ElseIf (LAnd (CondRefOf (\_SB.PCI0.CTCN), LEqual (CTDB, One)))
                {
                    CTCN ()
                }
            }
    ...
    Scope (_SB)
    {
        ...
        Device (FAPP)
        {
            ...
            Method (FNCX, 1, NotSerialized)
            {
                ...
                If (LEqual (Arg0, 0x81))
                {
                    If (LEqual (^^PCI0.LPCB.H_EC.TOUC, One))
                    {
                        Store (Zero, ^^PCI0.LPCB.H_EC.TOUC)
                    }
                    Else
                    {
                        Store (One, ^^PCI0.LPCB.H_EC.TOUC)
                    }

                    Store (^^PCI0.LPCB.H_EC.TOUC, ^^PCI0.LPCB.TCPD)
                }

                If (LEqual (Arg0, 0x82))
                {
                    If (LEqual (^^PCI0.LPCB.H_EC.BLTH, One))
                    {
                        Store (Zero, ^^PCI0.LPCB.H_EC.BLTH)
                    }
                    Else
                    {
                        Store (One, ^^PCI0.LPCB.H_EC.BLTH)
                    }

                    Store (^^PCI0.LPCB.H_EC.BLTH, ^^PCI0.LPCB.BLTE)
                }

                If (LEqual (Arg0, 0x83))
                {
                    If (LEqual (^^PCI0.LPCB.H_EC.WIRE, One))
                    {
                        Store (Zero, ^^PCI0.LPCB.H_EC.WIRE)
                    }
                    Else
                    {
                        Store (One, ^^PCI0.LPCB.H_EC.WIRE)
                    }

                    Store (^^PCI0.LPCB.H_EC.WIRE, ^^PCI0.LPCB.WLST)
                }
                ...
                If (LEqual (APPS (0x85, Arg0), 0x85))
                {
                    ...
                    If (LEqual (Local0, 0x07))
                    {
                        ...
                        Store (0x0400, ^^PCI0.GFX0.NDL2)
                        Store (0x0300, ^^PCI0.GFX0.NDL3)
                    }

                    If (LEqual (Local0, 0x06))
                    {
                        Store (0x0300, ^^PCI0.GFX0.CADL)
                        Store (Zero, ^^PCI0.GFX0.CAL2)
                        Store (Zero, ^^PCI0.GFX0.CAL3)
                    ...
                    If (LEqual (Local0, 0x04))
                    {
                        ...
                        {
                            Store (0x0400, ^^PCI0.GFX0.CADL)
                            Store (0x0100, ^^PCI0.GFX0.CAL2)
                            Store (Zero, ^^PCI0.GFX0.CAL3)
                        }
                ...
                If (LEqual (Arg0, 0x86))
                {
                    Store (One, ^^PCI0.LPCB.H_EC.APPE)
                }

                If (LEqual (Arg0, 0x87))
                {
                    Store (Zero, ^^PCI0.LPCB.H_EC.APPE)
                }

                If (LEqual (Arg0, 0x88))
                {
                    Store (One, ^^PCI0.LPCB.H_EC.FANM)
                }

                If (LEqual (Arg0, 0x89))
                {
                    Store (0x02, ^^PCI0.LPCB.H_EC.FANM)
                }

                If (LEqual (Arg0, 0x90))
                {
                    Store (0x03, ^^PCI0.LPCB.H_EC.FANM)
                }

                If (LEqual (Arg0, 0x91))
                {
                    Store (One, ^^PCI0.LPCB.H_EC.EN_L)
                    Store (Zero, ^^PCI0.LPCB.H_EC.DI_L)
                }

                If (LEqual (Arg0, 0x92))
                {
                    Store (Zero, ^^PCI0.LPCB.H_EC.EN_L)
                    Store (One, ^^PCI0.LPCB.H_EC.DI_L)
                }
                ...
                If (LEqual (Arg0, 0x97))
                {
                    If (^^PCI0.LPCB.G3GP)
                    {
                        ...
                        {
                            Store (0x99, ^^PCI0.LPCB.H_EC.G3GS)
                        }
                        Else
                        {
                            Store (0x88, ^^PCI0.LPCB.H_EC.G3GS)
                        }
                    }
                }
                ...
                If (LEqual (Arg0, 0x99))
                {
                    If (^^PCI0.LPCB.H_EC.CAME)
                    {
                        Store (Zero, ^^PCI0.LPCB.H_EC.CAME)
                    }
                    Else
                    {
                        Store (One, ^^PCI0.LPCB.H_EC.CAME)
                    }

                    Store (^^PCI0.LPCB.H_EC.CAME, ^^PCI0.LPCB.CAMS)
                }
            }
            ...
            Method (GETX, 1, NotSerialized)
            {
                ...
                If (LEqual (Arg0, 0x85))
                {
                    Return (^^PCI0.LPCB.H_EC.RTMP)
                }

                If (LEqual (Arg0, 0x86))
                {
                    Return (^^PCI0.LPCB.H_EC.CFAN)
                }
                ...
                If (LEqual (Arg0, 0x87))
                {
                    ...
                    Store (Zero, TMP2)
                    Store (Zero, TMP3)
                    Or (^^PCI0.GFX0.CPDL, TMP1, TMP1)
                    Or (^^PCI0.GFX0.CPL2, TMP1, TMP1)
                    Or (^^PCI0.GFX0.CPL3, TMP1, TMP1)
                    If (Or (LEqual (TMP1, 0x0700), LEqual (TMP1, 0x0300)))
                    {
                        Add (TMP3, ^^PCI0.GFX0.CPDL, TMP3)
                        Add (TMP3, ^^PCI0.GFX0.CPL2, TMP3)
                        Add (TMP3, ^^PCI0.GFX0.CPL3, TMP3)
                    ...
                    ShiftLeft (TMP1, 0x08, TMP1)
                    Store (Zero, TMP2)
                    Or (^^PCI0.GFX0.CADL, TMP2, TMP2)
                    Or (^^PCI0.GFX0.CAL2, TMP2, TMP2)
                    Or (^^PCI0.GFX0.CAL3, TMP2, TMP2)
                    If (Or (LEqual (TMP2, 0x0700), LEqual (TMP2, 0x0300)))
                    {
                        Store (Zero, TMP3)
                        Add (TMP3, ^^PCI0.GFX0.CADL, TMP3)
                        Add (TMP3, ^^PCI0.GFX0.CAL2, TMP3)
                        Add (TMP3, ^^PCI0.GFX0.CAL3, TMP3)
                        If (LEqual (TMP3, 0x0700))
                        {
                            Store (0x0600, TMP2)
                        }
                ...
                {
                    Store (Zero, TMP1)
                    Store (^^PCI0.LPCB.H_EC.CTLC, TMP1)
                    ShiftLeft (TMP1, 0x08, TMP1)
                    Or (^^PCI0.LPCB.H_EC.CTLH, TMP1, TMP1)
                    ShiftLeft (TMP1, 0x08, TMP1)
                    Or (^^PCI0.LPCB.H_EC.CTLL, TMP1, TMP1)
                    Return (TMP1)
                }
        ...
        Device (HIDD)
        {
            ...
            Method (BTNS, 0, Serialized)
            {
                If (LEqual (BID, 0x31))
                {
                    Store (^^PCI0.LPCB.H_EC.ECRD (RefOf (^^PCI0.LPCB.H_EC.BTEN)), BTS1)
                }
